...
export const PostagemPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await ApiPostar(titulo, endereco, descricao, foto);
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center h-full w-full mt-[20px] gap-[10px]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-[20px] bg-white shadow rounded p-[20px] w-full max-w-xl">
          <div>
