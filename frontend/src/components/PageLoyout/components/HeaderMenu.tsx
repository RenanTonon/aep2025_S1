    ...
    return (
        <div className="flex w-full h-[80px] bg-gradient-to-r from-[#332896] to-[#3E31B1] justify-around items-center pt-[10px] pb-[10px]">
            ...
            <div className='flex items-center gap-[20px] text-white'>
                <button className='flex bg-white w-[150px] pt-[8px] pb-[8px] justify-center rounded-[20px] text-[#332896] hover:bg-[#332896] hover:text-white transition-colors duration-300 cursor-pointer'>ENTRAR</button>
                <MenuIcon />
            </div>
        </div>
    )
